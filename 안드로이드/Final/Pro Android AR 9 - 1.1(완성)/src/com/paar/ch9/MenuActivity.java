...
public class MenuActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		patrol.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://troll.kert.or.kr:8080/memory/Service?action=shareList"));
				startActivity(intent);
			}
		});

		//마이웹
		//메인 페이지로 이동한 후에 로그인하도록 설정함(http://155.230.52.63:8080/memory)
		myWeb.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				Log.d("myWeb", "myWeb 진입");
				
				Intent intent = new Intent(MenuActivity.this,
						MyWebActivity.class);
				startActivity(intent);
				/*Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://155.230.52.63:8080/memory"));
				startActivity(intent);	*/
			}
		});
	}
