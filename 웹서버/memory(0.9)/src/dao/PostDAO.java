...
public class PostDAO {
	...
	public static ArrayList<Post> selectByUserId(String userId) throws SQLException{
		return (ArrayList<Post>) DAOParser.getParser().queryForList("Post.selectByUserId", userId);
	}
	
	public static ArrayList<Post> selectByUserIdUptime(HashMap<String, String> map) throws SQLException{
		return (ArrayList<Post>)DAOParser.getParser().queryForList("Post.selectByUserIdUptime", map);
	}
