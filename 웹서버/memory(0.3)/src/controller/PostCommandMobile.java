...
public class PostCommandMobile extends Command {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response)
		...
		try{
			service.insertMessage(new Post(1,1, (String) session.getAttribute("userId"), title, shopname, category, tel, image, imageNumber, text, m.getParameter("uptime"), Double.parseDouble(m.getParameter("latitude")),  Double.parseDouble(m.getParameter("longitude"))));
