			...
			<div class="row" id="loginRow">
				...
				<div id="loginForm" align="right">
					...
					ID <input id="uid" name="uid" type="text" style="width: 100px"
						style="height:10px" /> &nbsp; &nbsp; Password <input
						id="upassword" name="upassword" type="password"
						style="width: 100px" style="height:10px" /> <input type="button"
						value="로그인" onclick="sendLoginInfo()" />
						<input type="button" value="회원가입" onclick="location.href='center/join.html'"/>
				</div>
				<!-- 회원가입은 추후 추가 -->
				<%
					} else {
