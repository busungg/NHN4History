		...
		<div class="row">
			...
			<div class="col span_4">
				...
				<div id="top-posts-2" class="widget widget_top-posts">
					<ul>
						<li><a href="#" class="bump-view" data-bump-view="tp">편한
								포스팅</a></li>
						<li><a href="#" class="bump-view" data-bump-view="tp">달력으로
								한눈에 파악</a></li>
						<li><a href="#" class="bump-view" data-bump-view="tp">친구들과의
								공유</a></li>
						<li><a href="#" class="bump-view" data-bump-view="tp">지도에
								위치표시</a></li>
						<li><a href="#" class="bump-view" data-bump-view="tp">핸드폰과
								연동</a></li>
					</ul>
				</div>
			...
			<div class="col span_8 col_last">
				<h2>
					<%=session.getAttribute("userId")%>님의 Calender
				</h2>
				<div id="calendar"></div>
				...
				//달력을 눌렀을시 상세페이지로 이동
				 $("#calendar").click(function() {
					...
					var mapView = "<%=(String)request.getAttribute("mapView")%>";
					
					location.href = "getDetail.jsp?"+"year="+uyear+"&month="+umonth+"&day="+uday+"&mapView="+mapView;					
				});
			</script>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col span_4">
						...
						<div id="top-posts-2" class="widget widget_top-posts">
							<ul>
								<li><a href="#" class="bump-view" data-bump-view="tp">내가
										지정한 기간안의 포스팅사진 확인</a></li>
								<li><a href="#" class="bump-view" data-bump-view="tp">제목으로
										찾기 힘든 것을 사진으로 쉽게</a></li>
								<li><a href="#" class="bump-view" data-bump-view="tp">클릭할
										필요없이 쉽게 사진 보기</a></li>
								<li><a href="#" class="bump-view" data-bump-view="tp">마우스만
										올리면 제목이.. 뚜둥!!</a></li>
							</ul>
						</div>
					</div>
