...
%>
	...
	<div id="NicEditor" align="center">
		<script type="text/javascript">
			...
			function isFile(str){
			    ...
			    try
			    {
			        ...
			        O.send();
			        (O.status==200) ? alert("파일 업로드 완료") : isFile(str);
			        return;
			    }
			    catch(er)
			    {
			...
			window.onload = function(){
				...
				{	
					...
					/* fileCheck("http://troll.kert.or.kr:8080/memory/upload"+imgName); */
					isFile("http://troll.kert.or.kr:8080/memory/upload/"+imgName);
		...
		<input type="submit" name="action" class="large button blue" style="width: 80px;" value="Upload" />
		...
		<button style="margin-right: 10px; margin-top: 10px; width:80px;" class="large button blue" onclick="check();">Save</button>
		<button type="reset" class="Large button red" style="width: 80px; margin-right: 10px; margin-top: 10px;"
