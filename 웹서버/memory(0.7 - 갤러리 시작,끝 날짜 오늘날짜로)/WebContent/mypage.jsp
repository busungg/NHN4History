...
<body>
	<div id="example" class="k-content">
		<div class="demo-section">
			...
			<%
			SimpleDateFormat formatter = new SimpleDateFormat ( "dd/MM/yyyy", Locale.KOREA );
			...
			<div id="example" class="k-content">
				...
				<div class="demo-section" style="width: 600px">
					...
					<input id="start" value=<%out.println(todayTime);%> /> 
					<label for="end" style="margin-left: 3em">End date:</label> 
					<input id="end" value=<%out.println(todayTime);%> />
				</div>
