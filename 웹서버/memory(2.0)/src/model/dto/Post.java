...
public class Post {
	private int postid; //포스팅 아이디(반드시 값 있음)
	...
	public Post(String userid, String title, String shopname, String category,
	...
	public Post(int postid, String userid, String title, String shopname,
			String category, String tel, String image, int imageNumber,
			String text, String uptime, double latitude, double longitude) {
		super();
		this.postid = postid;
		this.userid = userid;
		this.title = title;
