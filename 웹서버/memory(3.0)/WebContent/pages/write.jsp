...
<body>
	...
	<div id="allText" align="center">
		<br><br>
		<h1><font size="10">Posting</font></h1>
		<br><br>
		<table>
			<tr>
				<td width="20%">제목</td>
	...
	<div id="NicEditor" align="center">
		...
		<br>
		<form id="uploadForm" style="margin: 10px;" method="post"
			enctype="multipart/form-data" action="../fileupload.jsp">
			이미지 추가 <input name="upload" id="uploadFile" type="file" />
			<input type="submit" class="medium button blue" name="action"
				value="Upload">
		</form>
		...
		<button class="Large button blue" style="width: 100px; margin-right: 10px; margin-top: 10px;"
			onclick="check();">SAVE</button>
		<button type="reset" class="Large button red" style="width: 100px; margin-right: 10px; margin-top: 10px;"
		onclick="rset();">RESET</button>
	...
	<form id="goPostPC" action="/memory/Service?action=postP" method="post">
		<input type="hidden" id="htitle" name="htitle" value=""> <input
			type="hidden" id="htitleImage" name="htitleImage" value=""> <input
			type="hidden" id="hcategory" name="hcategory" value=""> <input
			type="hidden" id="hupTime" name="hupTime" value=""> <input
			type="hidden" id="hshopname" name="hshopname" value=""> <input
			type="hidden" id="htel" name="htel" value=""> <input
			type="hidden" id="hHtmlText" name="hHtmlText" value=""> <input
			type="hidden" id="hlatitude" name="hlatitude" value=""> <input
			type="hidden" id="hlongitude" name="hlongitude" value="">
	</form>
