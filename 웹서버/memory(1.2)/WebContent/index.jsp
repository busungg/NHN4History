...
<body class="page page-id-18 page-template-default noise" data-smooth-scrolling="1">
...
<a id="logo" href="./"> <img
								alt="memory" src="./images/memory.png" />
							</a>
</div><!--/span_3-->
					...
					<div class="container">
						<div class="col span_12">
							<div class="post-title">
								<h2>
									<span> Take photos of your favourite outfits,
	...
	<div id="footer-widgets">
		...
		<div class="container">
			...
			<div class="col span_3">
					...
					<li>
				<a href="http://www.seanhurley.com/new-seo-formula/" title="The New SEO Formula">The New SEO Formula</a>
						</li>
					<li>
				<a href="http://www.seanhurley.com/best-practices-for-post-interview-follow-ups/" title="Best practices for post interview follow ups">Best practices for post interview follow ups</a>
						</li>
					<li>
				<a href="http://www.seanhurley.com/my-favourite-iphone-app-2/" title="My favourite iphone app #2 &#8211; Analytics StatsWidget">My favourite iphone app #2 &#8211; Analytics StatsWidget</a>
						</li>
					<li>
				<a href="http://www.seanhurley.com/the-3-worst-questions-to-ask-in-an-interview/" title="The 3 worst questions to ask in an interview">The 3 worst questions to ask in an interview</a>
						</li>
					<li>
				<a href="http://www.seanhurley.com/how-to-price-your-freelance-business/" title="How to price your freelance business">How to price your freelance business</a>
						</li>
					<li>
				<a href="http://www.seanhurley.com/5-great-questions-to-ask-in-an-interview/" title="5 great questions to ask in an interview">5 great questions to ask in an interview</a>
						</li>
					<li>
				<a href="http://www.seanhurley.com/how-to-use-linkedin-to-find-a-job/" title="How to use LinkedIn to find a job">How to use LinkedIn to find a job</a>
						</li>
				</ul>
		</div>				     
				</div><!--/span_3-->
				...
				<div class="col span_3">
					 <!-- Footer widget area 3 -->
		              		<div id="recent-posts-3" class="widget widget_recent_entries">		<h4>video</h4>
		...
		<div class="row" id="copyright">
			...
			Contact mail : memory@google.com Tel: 010-4742-1444</p>
				...
				<div class="col span_6 col_last">
					<ul id="social">
						 <li><a href="http://www.twitter.com/96robots" class="twitter">twitter </a></li> 						 <li><a href="http://www.facebook.com/hurley.sean" class="facebook">facebook</a></li> 																		 <li><a href="ca.linkedin.com/in/seanhurley/" class="linkedin">linkedin </a></li> 						 <li><a href="http://www.youtube.com/user/dynamicclothing" class="youtube">youtube </a></li> 																		 <li><a href="http://www.seanhurley.com/feed/rss/" class="rss">rss </a></li> 																		
					</ul>
				</div>
