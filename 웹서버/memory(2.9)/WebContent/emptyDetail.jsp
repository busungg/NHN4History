...
<body>
	...
	<div id="all" align="center">
		...
		<div id="tabs"
			...
			align="center">
			<ul>
				포스트가 없습니다. 새로운 포스트를 작성해 보세요!	
			</ul>
			<!-- 포스팅 쓰기 버튼, location.href를 클릭시, 스마트 에디터가 있는 페이지로 이동하는 URL 주소를 적으면 된다. -->
			<input type="button" value="새 포스트" style="font-size:15pt;height: 100px;width: 200px" onclick="location.href='pages/write.jsp?date=<%=startDate%>'" />
		</div>
